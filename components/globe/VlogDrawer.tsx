...
export default function VlogDrawer({ isOpen, onClose, countryName, vlogs }: VlogDrawerProps) {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    "absolute top-0 right-0 z-50 h-full w-full max-w-sm border-l border-white/10 bg-[#02040a]/90 backdrop-blur-2xl transition-transform duration-300 ease-out sm:w-[400px]",
                                ...
                                {vlogs.map((vlog, idx) => (
                                    ...
                                    >
                                        <div className="relative aspect-video w-full bg-white/5 overflow-hidden">
                                            ...
                                            {/* You can add real thumbnails here later */}
                                        </div>
